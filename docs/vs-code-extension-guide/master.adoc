...
You can analyze your projects with the {ProductName} extension by creating a run configuration, running an analysis, and then reviewing and resolving migration issues detected by the extension.
